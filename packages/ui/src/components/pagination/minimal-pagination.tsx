...
export interface MinimalPaginationProps extends PaginationRootProps, VariantProps<typeof minimalPaginationVariants> {
...
const MinimalPagination = React.forwardRef<ElementRef<'div'>, MinimalPaginationProps>((props, ref) => {
  const {
    withEdges,
    withControls = true,
    getControlProps,
...
MinimalPagination.displayName = 'MinimalPagination';

export { MinimalPagination };
