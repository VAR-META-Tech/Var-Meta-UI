  ...
  <DialogPrimitive.DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'border-linear bg-white fixed left-[50%] top-[50%] z-50 grid max-h-screen w-full max-w-[400px] translate-x-[-50%] translate-y-[-50%] gap-4 overflow-auto border px-4 py-3 shadow-xl duration-200 rounded-lg md:w-full',
        className
      )}
      {...props}
    >
