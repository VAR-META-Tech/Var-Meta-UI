...
import { Form, type AutocompleteProps, type TextFieldProps } from '@var-meta/ui';
...
const meta: Meta = {
  title: 'Components/Autocomplete/AutocompleteField',
...
export const Default: StoryFn<typeof Form.Autocomplete> = DefaultTemplate.bind({});
