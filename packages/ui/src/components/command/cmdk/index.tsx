/**
 * * This is a forked version of https://github.com/pacocoursey/cmdk with the following changes:
 * ! use listRef.current instead of ref on command to track the ref when we use it on portal
 */
...
const List = React.forwardRef<HTMLDivElement, ListProps>((props, forwardedRef) => {
  ...
  return (
    <div
      ref={mergeRefs([ref, forwardedRef, context.listRef])}
      {...etc}
      cmdk-list=""
      role="listbox"
